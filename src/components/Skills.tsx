...
const skills: Skill[] = [
  ...
  { name: "JavaScript", category: "Language", level: 3, color: "50 98% 55%" },
  ...
  { name: "NestJS", category: "Framework", level: 2, color: "350 89% 62%" },
  { name: "Tailwind CSS", category: "Framework", level: 3, color: "199 89% 52%" },
  ...
  { name: "Socket.io", category: "Library", level: 2, color: "180 100% 50%" },
  { name: "VS Code", category: "Tool", level: 4, color: "207 89% 68%" },
];
