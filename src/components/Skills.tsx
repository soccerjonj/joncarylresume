...
const skills: Skill[] = [
  { name: "TypeScript", category: "Language", level: 2, color: "212 93% 62%" },
  { name: "JavaScript", category: "Language", level: 2, color: "50 98% 55%" },
  { name: "Python", category: "Language", level: 4, color: "207 89% 68%" },
  { name: "Java", category: "Language", level: 2, color: "10 80% 58%" },
  { name: "React", category: "Framework", level: 2, color: "193 95% 68%" },
  { name: "React Native", category: "Framework", level: 2, color: "193 95% 68%" },
  ...
  { name: "Tailwind CSS", category: "Framework", level: 2, color: "199 89% 52%" },
  { name: "Supabase", category: "Database", level: 3, color: "154 60% 51%" },
  { name: "MongoDB", category: "Database", level: 2, color: "122 39% 52%" },
  { name: "Firebase", category: "Database", level: 2, color: "38 92% 55%" },
